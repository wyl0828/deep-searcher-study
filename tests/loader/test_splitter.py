...
class TestSplitter(unittest.TestCase):
    ...
    def test_chunk_init(self):
        ...
        chunk = Chunk(
            text="Test text", reference="test_ref", metadata=metadata, embedding=embedding
        )
        self.assertEqual(chunk.text, "Test text")
        self.assertEqual(chunk.reference, "test_ref")
    ...
    def test_sentence_window_split(self):
        ...
        original_text = (
            "This is a test document. It has multiple sentences. This is for testing the splitter."
        )
        ...
        split_docs = [
            ...
            Document(
                page_content="This is for testing the splitter.", metadata={"reference": "test_doc"}
            ),
        ]

...
class TestJiekouAIEmbedding(unittest.TestCase):
    ...
    def test_init_default(self):
        ...
        # Check attributes
        self.assertEqual(embedding.model, "qwen/qwen3-embedding-8b")
    ...
    def test_embed_documents(self):
        ...
        self.mock_response.json.return_value = {
            "data": [{"index": i, "embedding": [0.1 * (i + 1)] * 1024} for i in range(3)]
        }
    ...
    def test_embed_documents_with_batching(self):
        ...
        def mock_batch_response(*args, **kwargs):
            ...
            mock_resp.json.return_value = {
                "data": [{"index": i, "embedding": [0.1] * 1024} for i in range(len(batch_input))]
            }

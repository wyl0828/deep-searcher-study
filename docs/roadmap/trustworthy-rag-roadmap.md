...
- 知识健康金标评测（2026-08-16 已实现）：`evaluation/datasets/knowledge_health_v1.json` 18 cases，
  覆盖单文档事实、跨文档综合（含 series 边界）、冲突资料、无答案/证据不足和对抗问题；逐 case 锁定
  公式 1.1 的分数、分维度扣分、动作与等级，并验证顺序不变性。
